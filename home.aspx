<%@ Page Title="" Language="C#" MasterPageFile="~/TiffinGOSite.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="TiffinGO.home" %>
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div>
                  ...
                  <a href="TiffinGOsignin.aspx" class="btn-book animate__animated animate__fadeInUp scrollto">Sign in</a>
                </div>
              </div>
            </div>
          </div>
                 ...
                 <div class="col-md-6  mx-auto">
                    ...
                    <div class="form-group">
                        <asp:Button class="btn book-a-table-btn btn-block " 
                            ID="Button3" runat="server" Text="Send Message" OnClick="Button3_Click"  />
